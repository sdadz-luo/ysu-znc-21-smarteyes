 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static inline void s_heap_push(int idx) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static inline int s_heap_pop(void) {
 ...
 * @brief 判断两个坐标是否相等
 */
__attribute__((section("ITCM_NonCacheable"))) static inline bool pos_equal(Point a, Point b) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static inline int get_smooth_idx(int x, int y, int dir) {
 ...
 * @brief 计算曼哈顿距离
 */
__attribute__((section("ITCM_NonCacheable"))) static inline uint16_t manhattan_distance(Point a, Point b) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool is_wall_bit(const uint16_t walls[MAP_ROWS], Point p) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool is_corner_deadlock(Point box, const uint16_t walls[MAP_ROWS]) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static uint32_t hash_state(const State *s) {
    uint32_t h = 5381;
    ...
    for (int i = 0; i < MAP_ROWS; i++) h = ((h << 5) + h) ^ (uint32_t)s->wall_bitmap[i];
 ...
 * @brief 判断两个状态是否相等
 */
__attribute__((section("ITCM_NonCacheable"))) static bool state_equal(const State *a, const State *b) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static int32_t hash_lookup_insert(const State *s, uint16_t g, int32_t from, uint8_t insert) {
 ...
 * @brief 推箱A*优先队列插入
 */
__attribute__((section("ITCM_NonCacheable"))) static void pq_push(PQNode node) {
 ...
 * @brief 推箱A*优先队列弹出
 */
__attribute__((section("ITCM_NonCacheable"))) static PQNode pq_pop(void) {
    PQNode top = pq[0];
    pq[0] = pq[--pq_size];
    uint32_t i = 0;
    while (1) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static uint8_t heuristic(const State *s) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool is_goal(const State *s) {
 ...
 * @param cnt 输出后继数量
 */
__attribute__((section("ITCM_NonCacheable"))) static void get_successors(const State *cur, State *res, uint8_t *cnt) {
    *cnt = 0;
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void bfs_compute_distances(Point start, const uint16_t walls[MAP_ROWS]) {
    for (int i = 0; i < MAP_ROWS; i++)
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void bfs_compute_reachability(Point start, const uint16_t obstacles[MAP_ROWS]) {
    g_dist_epoch++;
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void extract_turn_points(Path* p) {
    if (p->len == 0) return;
    uint16_t widx = 0;
 ...
 * @brief 墙位图哈希（验证缓存用）
 */
__attribute__((section("ITCM_NonCacheable"))) static uint32_t hash_walls(const uint16_t walls[MAP_ROWS]) {
    uint32_t h = 5381;
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool is_breakable_wall(Point pos) {
 ...
 * @brief 爆炸点有效性检查
 */
__attribute__((section("ITCM_NonCacheable"))) static bool is_valid_detonation_point(Point pos) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static inline bool can_explosion_cover_wall(Point detonate_pos, Point target_wall) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static uint16_t estimate_bomb_push_distance(Point bomb_pos, Point detonate_pos, Point player_pos) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static int16_t compute_approach_angle(int8_t dx, int8_t dy) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void parse_map_input(uint8_t map[MAP_ROWS][MAP_COLS]) {
    g_box_count = 0;
    g_target_count = 0;
    g_bomb_count = 0;
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static AStarResult solve_single_box_a_star(Point player, Point box, Point target,
 ...
 * @return 静态接近结果指针
 */
__attribute__((section("ITCM_NonCacheable"))) static ApproachResult* find_nearest_approach(uint8_t map[MAP_ROWS][MAP_COLS]) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void extract_start_turn_points(ApproachResult* res) {
 ...
 * @param sol 输出配对方案
 */
__attribute__((section("ITCM_NonCacheable"))) static void generate_greedy_pairing(SolutionSequence* sol) {
 ...
 * @return true 方案可行
 */
__attribute__((section("ITCM_NonCacheable"))) static bool backtrack_validate(SolutionSequence* sol) {
 ...
 * @param sol 待验证的配对方案
 */
__attribute__((section("ITCM_NonCacheable"))) static void validate_solution(SolutionSequence* sol) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void id_learning(uint8_t map[MAP_ROWS][MAP_COLS]) {
    parse_map_input(map);
    /* 模式二中炸弹视为墙（不可通行） */
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void id_record(int id) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool next_permutation(int *arr, int n) {
    int i = n - 2;
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void id_inference(void) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void extract_look_turn_points(VisitStep* plan) {
    int li = 0;
 ...
 * @brief 从ID配对构造解决方案
 */
__attribute__((section("ITCM_NonCacheable"))) static SolutionSequence* build_solution_from_id_pairing(void) {
 ...
 * @brief 从ID方案计算推箱子路径
 */
__attribute__((section("ITCM_NonCacheable"))) static Path path_id_calculate(SolutionSequence* sol) {
    Path rp = {0};
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void compute_player_region_with_walls(const uint16_t walls[MAP_ROWS], bool ignore_bombs) {
...
__attribute__((section("ITCM_NonCacheable"))) static void compute_player_region(void) {
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static void compute_box_influence(Point box, const uint16_t walls[MAP_ROWS],
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool simulate_box_deadlock(uint8_t box_idx, const uint16_t obstacles[MAP_ROWS],
    ...
    /* 炸弹也是障碍——玩家不能穿过炸弹去推箱子 */
    for (uint8_t i = 0; i < g_bomb_count; i++) {
        if (g_initial_bombs[i].x != BOMB_INVALID) /* 已消失的跳过 */
            g_obs_buf[g_initial_bombs[i].x] |= (1 << g_initial_bombs[i].y);
    }

    /* 快速预检：箱子当前能否被推动至少一步？若四方向全堵死则确定死锁 */
    {
        uint16_t saved_box_row = g_obs_buf[start_box.x];
        g_obs_buf[start_box.x] |= (1 << start_box.y); /* 箱子自身也是障碍 */
        bfs_compute_reachability(start_player, g_obs_buf);
        g_obs_buf[start_box.x] = saved_box_row;
        bool can_push = false;
        for (uint8_t d = 0; d < DIR_COUNT && !can_push; d++) {
            uint8_t dest_x = (uint8_t)(start_box.x + DIRS[d][0]);
            uint8_t dest_y = (uint8_t)(start_box.y + DIRS[d][1]);
            ...
            uint8_t px = (uint8_t)(start_box.x - DIRS[d][0]);
            uint8_t py = (uint8_t)(start_box.y - DIRS[d][1]);
            if (px >= MAP_ROWS || py >= MAP_COLS) continue;
            if (g_dist_epoch_tag[px][py] == g_dist_epoch) can_push = true;
        }
        if (!can_push) return true; /* 四方向全堵死 → 确定死锁，跳过BFS */
    }
 ...
 */
__attribute__((section("ITCM_NonCacheable"))) static bool simulate_box_to_target(uint8_t box_idx, Point target,
        ...
        for (uint8_t wi = 0; wi < wall_count; wi++) {
            ...
            for (uint8_t ci = 0; ci < cand_count; ci++) {
                ...
                for (uint8_t d = 0; d < DIR_COUNT && !bomb_can_reach; d++) {
                    ...
                    if (is_wall_bit(g_static_walls, (Point){adj_x, adj_y})) continue;
                    if (g_bomb_reach_map[bi][adj_x] & (1 << adj_y))
                        bomb_can_reach = true;
                }
            ...
            if (combo_count == 1 && !verify_bomb_push_feasibility(&combo_plans[0])) {
                ...
                for (uint8_t ci = 0; ci < combo_count && all_pushable; ci++) {
                    ...
                    for (uint8_t cj = 0; cj < combo_count; cj++) {
                        ...
                        if (cj != ci) g_initial_bombs[bj].x = BOMB_INVALID;
                    }
